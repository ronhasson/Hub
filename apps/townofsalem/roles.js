	var listTownProtective = [Bodyguard, Doctor]
	var listTownKilling = [Vigilante, Veteran, VampireHunter, Jailor]
	var listTownSupport = [Escort, Retributionist, Medium, Mayor, Transporter]
	var listTownInvestigative = [Sheriff, Investigator, Spy, Lookout]
	var listTown = listTownProtective.concat(listTownKilling).concat(listTownSupport).concat(listTownInvestigative)
	var listMafiaSupport = [Consigliere, Blackmailer, Consort]
	var listMafiaDeception = [Framer, Forger, Jailor, Disguiser]
	var listMafiaKilling = [Mafioso, Godfather]
	var listMafia = listMafiaSupport.concat(listMafiaDeception).concat(listMafiaKilling)
	var listNeutralKilling = [Werewolf, Arsonist, SerialKiller]
	var listNeutralChaos = [Vampire]
	var listNeutralEvil = [Witch, Jester, Executioner]
	var listNeutralBenign = [Troll, Survivor, Amnesiac]
	var listNeutral = listNeutralKilling.concat(listNeutralChaos).concat(listNeutralEvil).concat(listNeutralBenign)
	var listAny = listTown.concat(listMafia).concat(listNeutral)
	class Any {
	    constructor() {
	        this.eman = "Any";
	        this.canKill = false;
